    ...
    <div class="row container mx-auto my-3">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 my-3">
            <div class="card card-small card-post card-post--aside card-post--1">
                <div class="card-post__image" @if ($jasa->foto != null) style="background-image: url('{{asset('images/jual/'.@$jasa->foto)}}');" @else style="background-image: url('{{asset('images/default.png')}}" @endif>
